...
namespace Serilog.Demo.ElasticSearch
{
    [TestFixture]
    public class LoggingExample
    {
        ...
        [Test]
        public void Logging_Information_Message_To_ElasticSearch_Should_Not_Throw_Exception()
        {
        ...
        [Test]
        public void Logging_Warning_Message_To_ElasticSearch_Should_Not_Throw_Exception()
        {
            var infoObject = BuildTestInfoObject();
        ...
        [Test]
        public void Logging_Error_Message_To_ElasticSearch_Should_Not_Throw_Exception()
        {
        ...
        [Test]
        public void Logging_Debug_Message_To_ElasticSearch_Should_Not_Throw_Exception()
        {
            var infoObject = BuildTestInfoObject();
            var manualException = BuildTestException();
